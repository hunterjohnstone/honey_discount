...
export default function AddPromotionSection({userId}: {
    userId: number
}) {
            ...
            {isAddingPromotion ? (
                ...
                <div className="bg-white rounded-xl shadow-2xl p-6 w-full max-w-2xl border border-gray-100">
                    ...
                    <button
                        ...
                        className="px-5 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                    >
                        Create Promotion
                    </button>
                    </div>
